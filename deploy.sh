...
git config user.email "thureindev@outlook.com"

# Commit the build
git add .
git commit -m "Deploy to nandar-art repository"

# branch name is `main` on deploy repository
git branch -M main

# Add deploy repository as a remote
git remote add origin https://github.com/thureindev/nandar-art.git
